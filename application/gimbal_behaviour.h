...
#define GIMBAL_UP_KEY KEY_PRESSED_OFFSET_W
#define GIMBAL_DOWN_KEY KEY_PRESSED_OFFSET_S
#define GIMBAL_LEFT_KEY KEY_PRESSED_OFFSET_A
#define GIMBAL_RIGHT_KEY KEY_PRESSED_OFFSET_D
typedef enum
{
    GIMBAL_ZERO_FORCE = 0,
    GIMBAL_INIT,
