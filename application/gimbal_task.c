...
bool_t target_lock_on(void);
fp32 para_pass_yaw_angle(void);
/**
...
bool_t target_lock_on()
{
	return (gimbal_control.gimbal_yaw_motor.is_lockon && gimbal_control.gimbal_yaw_motor.is_autoaim);
}

fp32 para_pass_yaw_angle()
{
